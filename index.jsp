...
<html>
	<head>
		...
		<link href="/up/css/default.css" rel="stylesheet" type="text/css" />
		<link rel="stylesheet" href="/up/css/button.css" type="text/css" />
		
		<link rel="stylesheet" type="text/css" href="/up/ext/resources/css/ext-all.css" />
 		<script type="text/javascript" src="/up/ext/adapter/ext/ext-base.js"></script>
    	<script type="text/javascript" src="/up/ext/ext-all.js"></script>
  		<script type="text/javascript" src="/up/ext/ext-lang-zh_CN.js"></script>
		
		<script type="text/javascript" src="/up/js/swfupload/swfupload.js"></script>
		<script type="text/javascript" src="/up/js/swfupload/swfupload.queue.js"></script>
		<script type="text/javascript" src="/up/js/swfupload/handlers.js"></script>
		...
		<script type="text/javascript">
			...
			window.onload = function () {
				swfu = new SWFUpload({
					...
					// Button Settings
					button_image_url : "/up/images/SmallSpyGlassWithTransperancy_17x18.png",
					...
					// Flash Settings
					flash_url : "/up/js/swfupload/swfupload.swf",
