	...
	<div class="center cs">
		...
		<div class="side">
			<dl>
				...
				<dd  class="active"><a href="stores_notby.shtml">未通过分店</a></dd>
		...
		<div class="main">
			<h2>未通过分店</h2>
			<form action="storesFuzzzy_notby.shtml" method="post"  class="js-form">
			...
			<div class="ajaxpage" total="${pageSupport.totalRecordCount}" each="${pageSupport.pageSize}" page="${pageSupport.currentPageNo}" ajax="false" url="stores_notby.shtml"></div>  
