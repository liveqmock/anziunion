...
<body>
	...
	<div class="center cs">
		...
		<div class="side">
			<dl>
				<dt>分店管理</dt>
					<dd class="active"><a href="stores_list.shtml">分店列表</a></dd>
		...
		<div class="main">
			...
			<form action="storesFuzzzy_list.shtml" method="post"  class="js-form">
			...
			<div class="ajaxpage" total="${pageSupport.totalRecordCount}" each="${pageSupport.pageSize}" page="${pageSupport.currentPageNo}" ajax="false" url="stores_list.shtml"></div>  
		</div>
	</div>
