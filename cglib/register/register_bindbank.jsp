...
<jsp:param name="css" value="global,register" />
</jsp:include>
	...
	<!-- 	<h2 class="register_title">
		...
		<br><br> -->
		<c:if test="${messageCallBack !=null }">
			<input type="hidden" id="msg" value="${messageCallBack}">
		</c:if>
		<form action="merchantsBindbank.shtml" class="fukrm " method="post">
