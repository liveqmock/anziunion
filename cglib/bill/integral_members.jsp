...
<div class="main cs">
	...
	<h2 class="tle"><i class="icon icon-riqixuanzetubiao"></i>积分提现记录<small>查看您的提现信息</small></h2>
	...
	<div class="flots_time" >
		<form action="/gettakemoneyTime.shtml" class="fukrm table_tle" method="post">
			...
			<a class="btn_tab" href="/bill_members.shtml" >现金提现明细</a>
		</form>
	...
	<div class="table">
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tbody>
				...
				<tr>
					<td><fmt:formatDate value="${list.drawdate}"  pattern="yyyy-MM-dd hh:mm"/></td>
					<td>${list.beforeintegral }</td>
					<td>
						<span style="color: #f37800;"  class="monery">${list.amount}<img src="/images/moneys.png" title="点击查看详情" style="padding-top: 13px;padding-left: 10px;"></span>	
						<div class="monerys">
							<table cellpadding="1" cellspacing="1" class="tb-amout-more">
								<colgroup><col><col ></colgroup>
								<tbody>
									<tr><th>类型</th><th>说明</th></tr>
									<tr><th colspan="2">提现时间 <fmt:formatDate value="${list.drawdate}"  pattern="yyyy-MM-dd HH:mm:ss"/></th></tr>
									<tr><td>提现积分</td><td>${list.integral}</td></tr>
									<tr><td>银行卡号</td><td>${list.card}</td></tr>
									<tr><td>开户支行</td><td>${list.bankno}</td></tr>
								</tbody>
							</table>
						</div>
					</td>
					<td><span style="color: #53a000;">${list.afterintegral}</span></td>
					<td><span style="color: #53a000;">${list.discountintegral}</span></td>
					<td>${list.realname}</td>
